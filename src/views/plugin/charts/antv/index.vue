...
function renderPieChart() {
  ...
  const chart = new Chart({
    container: pieRef.value as HTMLElement,
    autoFit: true
  });
...
function renderLineChart() {
  fetch('https://gw.alipayobjects.com/os/antvdemo/assets/data/terrorism.json')
    ...
    .then(data => {
      ...
      const chart = new Chart({
        container: lineRef.value as HTMLElement,
        autoFit: true,
...
function renderBarChart() {
  ...
  const chart = new Chart({
    container: barRef.value as HTMLElement,
    autoFit: true,
    height: 500,
    padding: [50, 20, 50, 20]
  });
...
function renderScatterChart() {
  ...
  fetch('https://gw.alipayobjects.com/os/antvdemo/assets/data/bubble.json')
    ...
    .then(data => {
      ...
      const chart = new Chart({
        container: scatterRef.value as HTMLElement,
        autoFit: true,
        height: 500
      });
      chart.data(data);
...
function renderAreaChart() {
  ...
  const chart = new Chart({
    container: areaRef.value as HTMLElement,
    autoFit: true,
    height: 500
  });
...
function renderRadarChart() {
  ...
  const chart = new Chart({
    container: radarRef.value as HTMLElement,
    autoFit: true,
    height: 500
  });
  chart.data(dv.rows);
